...
CREATE TABLE `tbl_notif` (
  ...
  `notif_time` varchar(100) DEFAULT NULL,
  `notif_date` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Sedang dikaji ulang / review', 'Awal'),
(2, 'Pengajuan di batalkan', 'Pembatalan'),
(3, 'Selesai', 'Akhir'),
(5, 'Sedang proses kalibrasi', NULL),
(14, 'Sedang proses kalibrasi', 'Sedang ditangani'),
(15, 'Sedang ditangani', NULL),
(16, 'Sedang diajukan', NULL);
...
(185, 'admin', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', 'Administrator', 'haidirmustofa223@gmail.com', '6285790829138', 'Tanpa Divisi', 'Aktif', 'c861f6de4bfff0aeaa608e85a3a659d865bc5c6fc861f6de4bfff0aeaa608e85a3a659d865bc5c6f', 'Admin', 1),
(194, 'user1', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', 'user1', 'user@mail.co.id', '0000000000', '388', 'Aktif', NULL, 'Member', NULL),
(195, 'user2', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', 'user2', 'user@mail.co.id', '000000000', '390', 'Aktif', NULL, 'Member', NULL),
(196, 'user3', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', 'user3', 'user@mail.co.id', '0934785', '399', 'Aktif', NULL, 'Member', NULL);
