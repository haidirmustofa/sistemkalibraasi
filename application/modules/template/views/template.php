      ...
      <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav">
            ...
            <!-- <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?= base_url('data-kondisi') ?>" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Kondisi </span></a></li> -->
            <!-- <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?= base_url('data-divisi') ?>" aria-expanded="false"><i data-feather="users" class="feather-icon"></i><span class="hide-menu">Divisi </span></a></li> -->
            <!-- <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?= base_url('data-type') ?>" aria-expanded="false"><i data-feather="type" class="feather-icon"></i><span class="hide-menu">Tipe </span></a></li> -->
            <?php
